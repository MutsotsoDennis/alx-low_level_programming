 ...
 * If file_from does'nt exist or can'nt be read - exit code 98.
 * If file_to can'nt be produced or written to - exit code 99.
 * If file_to or file_from can'nt be closed - exit code 100.
 */
